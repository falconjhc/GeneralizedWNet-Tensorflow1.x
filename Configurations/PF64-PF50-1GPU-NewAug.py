...
hyperParams = {
        ...
        'expDir': '/data-shared/server02/data1/haochuan/Character/TrainRecords-TestArchitecture-NewAugument-202406/',
       ...
       [
        '/data-shared/server02/data1/haochuan/Character/2024-FeatureExtractorDemonstration/PF80/Models/checkpoint/Exp20240308_VGG16-FeatureExtractor_Content_PF80_vgg16net/variables/@/device:GPU:0',
        '/data-shared/server02/data1/haochuan/Character/2024-FeatureExtractorDemonstration/PF80/Models/checkpoint/Exp20240308_VGG19-FeatureExtractor_Content_PF80_vgg19net/variables//@/device:GPU:0',
        '/data-shared/server02/data1/haochuan/Character/2024-FeatureExtractorDemonstration/PF80/Models/checkpoint/Exp20240308_ResNet18-FeatureExtractor_Content_PF80_resnet18/variables/@/device:GPU:0',
        '/data-shared/server02/data1/haochuan/Character/2024-FeatureExtractorDemonstration/PF80/Models/checkpoint/Exp20240308_ResNet34-FeatureExtractor_Content_PF80_resnet34/variables/@/device:GPU:0',
