...
hyperParams = {
        'seed':1,
        'debugMode': 0,
        'expID':'20240519-ContentPF64-StylePF50-Seed1Org',# experiment name prefix
        'expDir': '/data-shared/server02/data1/haochuan/Character/TrainRecords-20240519TestSeeds/',
        ...
        'generator': 'SwinWNet-AvgMaxConvResidualMixer-BasicBlockDecoder',
        'discriminator':'NA',
